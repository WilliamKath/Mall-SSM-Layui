            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <select name="typeId" class="layui-input" lay-filter="test">
                        ...
                        <option value="staffId" id="searchId">编号</option>
                    </select>
                </div>
            </div>
            <div class="layui-inline">
...
<div id="addOrUpdateDiv" style="display: none;margin: 10px">
    <form id="dataForm" method="post" class="layui-form  layui-form-pane" lay-filter="dataForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="staffName" placeholder="请输入姓名" lay-verify="required" lay-reqText="请输入姓名"  autocomplete="off" class="layui-input" style="width: 100px">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">年龄</label>
            <div class="layui-input-block">
                <input type="text" name="staffAge" placeholder="请输入年龄" lay-verify="number" lay-reqText="请输入年龄"  autocomplete="off" class="layui-input" style="width: 100px">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">性别</label>
            <div class="layui-input-block" id="Sex">
                <input name="staffSex" type="radio" class="layui-input" lay-verify="required" value="男" title="男">
                <input name="staffSex" type="radio" class="layui-input" lay-verify="required" value="女" title="女">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">手机号码</label>
            <div class="layui-input-inline">
                <input type="text" name="staffPhone"   lay-verify="phone" placeholder="请输入手机号码"  lay-reqText="请输入手机号码"   autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">备注</label>
            <div class="layui-input-block">
                <textarea placeholder="请输入备注信息" name="staffNote" class="layui-textarea" ></textarea>
            </div>
        </div>
...
<script>
    layui.use(['form','jquery','table','laydate','layer'], function(){
        ...
        var staff_table = table.render({
            ...
            ,cols: [[ //表头
                {type:'checkbox'}
                ,{field: 'staffId', title: '编号', width:80, sort: true}
                ,{field: 'staffName', title: '姓名', width:150}
                ,{field: 'staffAge', title: '年龄', width:80, sort: true}
                ,{field: 'staffSex', title: '性别', width:80}
                ,{field: 'staffPhone', title: '手机号码', width: 150}
                ,{field: 'staffNote',title: '备注',width:250}
